...
def reduce_mh_model_to_sh(
    ...
    for layer in range(num_layers-1):
        ...
        mh_weight = mh_weight[head_idx].T if mh_weight[head_idx].ndim == 2 else mh_weight[head_idx]
        mh_bias = mh_bias[head_idx].T if mh_bias[head_idx].ndim == 2 else mh_bias[head_idx]
