...
def get_model_settings_flax_to_torch(
    ...
    return dict(
        ...
        dtype=dtype,
        atomic_type_shifts=cfg.data.energy_shifts.to_dict() if use_defined_shifts else None,
        learn_atomic_type_shifts=cfg.model.energy_learn_atomic_type_shifts,
        learn_atomic_type_scales=cfg.model.energy_learn_atomic_type_scales,
...
def convert_flax_to_torch(
    ...
    if save_torch_settings:
        ...
        serializable_settings['dtype'] = str(dtype)  # Convert torch.dtype to string
...
def get_torch_to_flax_mapping(
    ...
    # Embedding layers
    mapping["inv_feature_embedding.embedding.weight"] = "params/feature_embeddings_0/Embed_0/embedding"
    if trainable_rbf:   
        mapping["radial_embedding.radial_basis_fn.centers"] = "params/geometry_embeddings_0/rbf_fn/centers"
        mapping["radial_embedding.radial_basis_fn.widths"] = "params/geometry_embeddings_0/rbf_fn/widths"
    
    if use_charge_embed and not use_spin_embed:
        mapping["charge_embedding.Wq.weight"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Embed_0/embedding"
        mapping["charge_embedding.Wk"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Embed_1/embedding"
        mapping["charge_embedding.Wv"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Embed_2/embedding"
        mapping["charge_embedding.mlp.1.weight"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Residual_0/layers_0/kernel"
        mapping["charge_embedding.mlp.3.weight"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Residual_0/layers_1/kernel"
    elif use_spin_embed and not use_charge_embed:
        mapping["spin_embedding.Wq.weight"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Embed_0/embedding"
        mapping["spin_embedding.Wk"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Embed_1/embedding"
        mapping["spin_embedding.Wv"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Embed_2/embedding"
        mapping["spin_embedding.mlp.1.weight"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Residual_0/layers_0/kernel"
        mapping["spin_embedding.mlp.3.weight"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Residual_0/layers_1/kernel"
    elif use_charge_embed and use_spin_embed:
        mapping["charge_embedding.Wq.weight"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Embed_0/embedding"
        mapping["charge_embedding.Wk"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Embed_1/embedding"
        mapping["charge_embedding.Wv"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Embed_2/embedding"
        mapping["charge_embedding.mlp.1.weight"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Residual_0/layers_0/kernel"
        mapping["charge_embedding.mlp.3.weight"] = "params/feature_embeddings_1/ChargeSpinEmbedSparse_0/Residual_0/layers_1/kernel"
        mapping["spin_embedding.Wq.weight"] = "params/feature_embeddings_2/ChargeSpinEmbedSparse_0/Embed_0/embedding"
        mapping["spin_embedding.Wk"] = "params/feature_embeddings_2/ChargeSpinEmbedSparse_0/Embed_1/embedding"
        mapping["spin_embedding.Wv"] = "params/feature_embeddings_2/ChargeSpinEmbedSparse_0/Embed_2/embedding"
        mapping["spin_embedding.mlp.1.weight"] = "params/feature_embeddings_2/ChargeSpinEmbedSparse_0/Residual_0/layers_0/kernel"
        mapping["spin_embedding.mlp.3.weight"] = "params/feature_embeddings_2/ChargeSpinEmbedSparse_0/Residual_0/layers_1/kernel"
    ...
    for i in range(num_layers):
        ...
        # Radial filters (inv)
        mapping[f"{torch_prefix}.filter_net_inv.mlp_rbf.0.weight"] = f"{flax_prefix}/radial_filter1_layer_1/kernel"
        mapping[f"{torch_prefix}.filter_net_inv.mlp_rbf.0.bias"] = f"{flax_prefix}/radial_filter1_layer_1/bias"
        mapping[f"{torch_prefix}.filter_net_inv.mlp_rbf.mlp_rbf_layer_1.0.weight"] = f"{flax_prefix}/radial_filter1_layer_2/kernel"
        mapping[f"{torch_prefix}.filter_net_inv.mlp_rbf.mlp_rbf_layer_1.0.bias"] = f"{flax_prefix}/radial_filter1_layer_2/bias"

        # Radial filters (ev)
        mapping[f"{torch_prefix}.filter_net_ev.mlp_rbf.0.weight"] = f"{flax_prefix}/radial_filter2_layer_1/kernel"
        mapping[f"{torch_prefix}.filter_net_ev.mlp_rbf.0.bias"] = f"{flax_prefix}/radial_filter2_layer_1/bias"
        mapping[f"{torch_prefix}.filter_net_ev.mlp_rbf.mlp_rbf_layer_1.0.weight"] = f"{flax_prefix}/radial_filter2_layer_2/kernel"
        mapping[f"{torch_prefix}.filter_net_ev.mlp_rbf.mlp_rbf_layer_1.0.bias"] = f"{flax_prefix}/radial_filter2_layer_2/bias"

        # Spherical filters (inv)
        mapping[f"{torch_prefix}.filter_net_inv.mlp_ev.0.weight"] = f"{flax_prefix}/spherical_filter1_layer_1/kernel"
        mapping[f"{torch_prefix}.filter_net_inv.mlp_ev.0.bias"] = f"{flax_prefix}/spherical_filter1_layer_1/bias"
        mapping[f"{torch_prefix}.filter_net_inv.mlp_ev.mlp_ev_layer_1.0.weight"] = f"{flax_prefix}/spherical_filter1_layer_2/kernel"
        mapping[f"{torch_prefix}.filter_net_inv.mlp_ev.mlp_ev_layer_1.0.bias"] = f"{flax_prefix}/spherical_filter1_layer_2/bias"

        # Spherical filters (ev)
        mapping[f"{torch_prefix}.filter_net_ev.mlp_ev.0.weight"] = f"{flax_prefix}/spherical_filter2_layer_1/kernel"
        mapping[f"{torch_prefix}.filter_net_ev.mlp_ev.0.bias"] = f"{flax_prefix}/spherical_filter2_layer_1/bias"
        mapping[f"{torch_prefix}.filter_net_ev.mlp_ev.mlp_ev_layer_1.0.weight"] = f"{flax_prefix}/spherical_filter2_layer_2/kernel"
        mapping[f"{torch_prefix}.filter_net_ev.mlp_ev.mlp_ev_layer_1.0.bias"] = f"{flax_prefix}/spherical_filter2_layer_2/bias"

        # Attention weights
        mapping[f"{torch_prefix}.euclidean_attention_block.W_q_inv"] = f"{flax_prefix}/Wq1"
        mapping[f"{torch_prefix}.euclidean_attention_block.W_k_inv"] = f"{flax_prefix}/Wk1"
        mapping[f"{torch_prefix}.euclidean_attention_block.W_v_inv"] = f"{flax_prefix}/Wv1"
        mapping[f"{torch_prefix}.euclidean_attention_block.W_q_ev"] = f"{flax_prefix}/Wq2"
        mapping[f"{torch_prefix}.euclidean_attention_block.W_k_ev"] = f"{flax_prefix}/Wk2"

        # Exchange block
        mapping[f"{torch_prefix}.interaction_block.linear_layer.weight"] = f"params/layers_{i}/exchange_block/mlp_layer_2/kernel"
        mapping[f"{torch_prefix}.interaction_block.linear_layer.bias"] = f"params/layers_{i}/exchange_block/mlp_layer_2/bias"

        # Layer normalization
        if layer_norm_1:
            mapping[f"{torch_prefix}.layer_norm_inv_1.weight"] = f"params/layers_{i}/layer_normalization_1/scale"
            mapping[f"{torch_prefix}.layer_norm_inv_1.bias"] = f"params/layers_{i}/layer_normalization_1/bias"
        if layer_norm_2:
            mapping[f"{torch_prefix}.layer_norm_inv_2.weight"] = f"params/layers_{i}/layer_normalization_2/scale"
            mapping[f"{torch_prefix}.layer_norm_inv_2.bias"] = f"params/layers_{i}/layer_normalization_2/bias"
    ...
    mapping["atomic_energy_output_block.final_layer.weight"] = "params/observables_0/energy_dense_final/kernel"
    mapping["atomic_energy_output_block.final_layer.bias"] = "params/observables_0/energy_dense_final/bias"
    if learn_atomic_type_shifts:
        mapping["atomic_energy_output_block.energy_shifts.weight"] = "params/observables_0/energy_offset"
    if learn_atomic_type_scales:
        mapping["atomic_energy_output_block.energy_scales.weight"] = "params/observables_0/atomic_scales"
    ...
    if use_electrostatic_energy:
        mapping["partial_charges_output_block.atomic_embedding.weight"] = f"{params_obs}electrostatic_energy/partial_charges/Embed_0/embedding"
        mapping["partial_charges_output_block.transform_inv_features.0.weight"] = f"{params_obs}electrostatic_energy/partial_charges/charge_dense_regression_vec/kernel"
        mapping["partial_charges_output_block.transform_inv_features.0.bias"] = f"{params_obs}electrostatic_energy/partial_charges/charge_dense_regression_vec/bias"
        mapping["partial_charges_output_block.transform_inv_features.2.weight"] = f"{params_obs}electrostatic_energy/partial_charges/charge_dense_final_vec/kernel"
        mapping["partial_charges_output_block.transform_inv_features.2.bias"] = f"{params_obs}electrostatic_energy/partial_charges/charge_dense_final_vec/bias"

    if use_dispersion_energy:
        mapping["hirshfeld_output_block.v_shift_embedding.weight"] = "params/observables_2/Embed_0/embedding"
        mapping["hirshfeld_output_block.q_embedding.weight"] = "params/observables_2/Embed_1/embedding"
        mapping["hirshfeld_output_block.transform_features.0.weight"] = "params/observables_2/hirshfeld_ratios_dense_regression/kernel"
        mapping["hirshfeld_output_block.transform_features.0.bias"] = "params/observables_2/hirshfeld_ratios_dense_regression/bias"
        mapping["hirshfeld_output_block.transform_features.2.weight"] = "params/observables_2/hirshfeld_ratios_dense_final/kernel"
        mapping["hirshfeld_output_block.transform_features.2.bias"] = "params/observables_2/hirshfeld_ratios_dense_final/bias"
...
def get_model_settings_torch_to_flax(
    ...
    cfg.model.cutoff_lr = torch_settings.get('r_max_lr', torch_settings['r_max'])
    ...
    cfg.model.radial_basis_fn = torch_settings.get('radial_basis_fn', 'gaussian')
    cfg.model.message_normalization = torch_settings.get('message_normalization', 'sqrt_num_features')
    cfg.model.energy_learn_atomic_type_shifts = torch_settings.get('learn_atomic_type_shifts', False)
    cfg.model.energy_learn_atomic_type_scales = torch_settings.get('learn_atomic_type_scales', False)
    cfg.model.energy_regression_dim = torch_settings.get('energy_regression_dim', None)
    cfg.model.layer_normalization_1 = torch_settings.get('layer_normalization_1', False)
    cfg.model.layer_normalization_2 = torch_settings.get('layer_normalization_2', False)
    ...
    cfg.model.zbl_repulsion_bool = torch_settings.get('zbl_repulsion_bool', False)
    cfg.model.electrostatic_energy_bool = torch_settings.get('electrostatic_energy_bool', False)
    cfg.model.electrostatic_energy_scale = torch_settings.get('electrostatic_energy_scale', 1.0)
    cfg.model.dispersion_energy_bool = torch_settings.get('dispersion_energy_bool', False)
    cfg.model.dispersion_energy_cutoff_lr_damping = torch_settings.get('dispersion_energy_cutoff_lr_damping', None)
    cfg.model.dispersion_energy_scale = torch_settings.get('dispersion_energy_scale', 1.0)
    cfg.model.num_features_head = torch_settings.get('num_features_head', None)
    cfg.model.qk_non_linearity = torch_settings.get('qk_non_linearity', "identity")
    cfg.model.activation_fn = torch_settings.get('activation_fn', None)
    cfg.model.layers_behave_like_identity_fn_at_init = torch_settings.get('layers_behave_like_identity_fn_at_init', False)
    cfg.model.output_is_zero_at_init = torch_settings.get('output_is_zero_at_init', False)
    cfg.model.input_convention = torch_settings.get('input_convention', 'positions')
    cfg.model.energy_activation_fn = torch_settings.get('energy_activation_fn', "silu")
    ...
    if torch_settings.get('atomic_type_shifts') is not None:
        cfg.data.energy_shifts = config_dict.ConfigDict(torch_settings['atomic_type_shifts'])
    else:
...
def convert_torch_to_flax_params(
    ...
    for torch_key, flax_key in mapping.items():
        ...
        if (flax_key == "params/observables_0/energy_offset" or 
            flax_key == "params/observables_0/atomic_scales"):
